...
**THIS IS THE SOURCE CODE. If you just want to run the *Time Stamper* program, [download the executable from the "Assets" tab under the latest release on the "releases" page here](https://github.com/benfertig/timestamper/releases/).**<br />
