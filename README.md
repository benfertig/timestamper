...
* This button pauses the timer (see 27). You must have already selected an output file (see 7) and begun recording (see 6) to be able to press the pause button.
