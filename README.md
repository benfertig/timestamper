...
**THIS IS THE SOURCE CODE. If you just want to run the *Time Stamper* program, [download the latest executable from the releases page here](https://github.com/benfertig/timestamper/releases/).**<br />
