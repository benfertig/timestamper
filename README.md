...
## Usage Instructions
![src/ts_images/help_images/timestamper_window_labeled_webimage.png](https://github.com/benfertig/timestamper/blob/main/src/ts_images/help_images/timestamper_window_labeled_webimage.png?raw=true)
