...
### 17 - Timer
* This area displays the timer's current time. As long as the timer is not running, these values can be edited. The minimum time supported by this timer is 00:00:00.00 and the maximum supported time is 99:59:59.99.
