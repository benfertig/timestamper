...
* **If you are building version 0.3.0 or later of the *Time Stamper* program**, then you selected "One Directory".
* **If you are building a version of the *Time Stamper* program that is older than version 0.3.0 (e.g., version 0.1.0 or 0.2.0)**, then you selected "One File".
...
* **If you selected the "One File" option:**
    ...
    * You can move this executable file to wherever you like on your computer without having to worry about grouping the executable with other dependencies, as all of the executable's dependencies are bundled in the executable file itself.
...
The name of the *Inno Setup* configuration file for the *Time Stamper* installer will change depending on which version of the *Time Stamper* program the source code you downloaded is associated with. You can find the *Inno Setup* configuration file for the *Time Stamper* program in the following directory, replacing {path_to_repository} with the directory that you have saved the *timestamper* repository to on your computer:
```
{path_to_repository}\extra_files\setup_files\windows
```
...
You can edit any properties of the *Time Stamper* installer in this configuration file (which you will **need** to do if you either built version 0.3.0 or later of the *Time Stamper* program in "One File" mode or built a version of the *Time Stamper* program prior to version 0.3.0 in "One Directory" mode). I will not go over the meanings of the variables found in this configuration file. To learn more about what each setting in this configuration file does, refer to [the "Help" page on the *Inno Setup* website](https://jrsoftware.org/ishelp/).
