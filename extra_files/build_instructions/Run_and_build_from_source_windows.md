...
If neither of these conditions apply to you (i.e., if you are trying to build version 0.3.0 or greater in "One File" mode or a version prior to 0.3.0 in "One Directory" mode), then you are on your own, as you will need to tweak some settings within the *Inno Setup* .iss file, which is located in the following directory:
```
