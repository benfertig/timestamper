...
* Paste the file(s) you copied into the following directory, replacing {path_to_repository} with the directory that you have saved the *timestamper* repository to and replacing {version_number} with the version of the *Time Stamper* program the source code you downloaded is associated with
    ```
